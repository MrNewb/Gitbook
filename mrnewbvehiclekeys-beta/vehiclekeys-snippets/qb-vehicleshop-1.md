...
{% hint style="warning" %}
This snippet is specifically for the admin vehicle spawn flow. If your server has other admin tools or custom menus, they may need the same replacement pattern.
{% endhint %}
...
{% hint style="success" %}
The important change here is switching from the old resource-specific export to the native MrNewbVehicleKeys give-key call using the spawned vehicle net ID.
{% endhint %}
