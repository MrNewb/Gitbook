...
<figure><img src="../../.gitbook/assets/image.png" alt="The jg-dealerships key system config option set to MrNewbVehicleKeys"><figcaption><p>Set the <strong>Keys</strong> config option to <strong>MrNewbVehicleKeys</strong></p></figcaption></figure>
