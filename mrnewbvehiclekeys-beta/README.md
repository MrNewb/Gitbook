...
| --- | --- |
| Install the script | [Install Guide](vehiclekeys-install/README.md) |
| Tune gameplay and server behavior | [Configuration Guide](vehiclekeys-install/configuration.md) |
| Find commands and keybinds | [Commands](vehiclekeys-faq-1.md) |
| Check common setup questions | [FAQ](vehiclekeys-faq.md) |
| Integrate another script | [Exports](vehicle-keys-exports/README.md) |
| Keep old qb-style integrations alive | [Backwards Events](backwards-events/README.md) |
